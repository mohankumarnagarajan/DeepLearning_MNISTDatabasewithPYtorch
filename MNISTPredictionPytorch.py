...
class MNIST_Pytorch(nn.module):
    def __init__(self, imgpath='~/.pytorch/MNIST_data/'):
        ...
        self.optimizer = optim.SGD(model.parameters(), lr=0.003)
    ...
    def preprocessImage(self):
        ...
        self.trainset = datasets.MNIST(self.imagepath, download=True, train=True, transform=transform)
